    ...
    <div className="group flex h-full min-w-0 flex-col overflow-hidden border-2 border-slate-100 bg-white transition-all duration-300 hover:border-orange-500">
      ...
      >
        <div className="relative">
          <div className="aspect-square overflow-hidden bg-white p-2 sm:p-3">
            <img
        ...
        <div className="flex min-w-0 flex-1 flex-col px-3 pb-0 pt-1.5 md:px-3">
          <p className="truncate text-[9px] font-black uppercase tracking-[0.2em] text-orange-600">
            {product?.category}
          </p>
          <h3 className="mt-0.5 min-w-0 line-clamp-1 text-sm font-semibold tracking-normal text-slate-950 sm:text-base">
            {product?.productName}
          </h3>
          ...
          <div className="mt-0.5 flex min-w-0 flex-wrap items-end gap-2">
