...
const adminCreateUser = require('../controller/user/adminCreateUser');
...
const adminCreateOrder = require('../controller/order/adminCreateOrder');
...
router.post("/create-order", authToken, requireRole('ADMIN'), adminCreateOrder);
...
router.post("/create-user", authToken, requireRole('ADMIN'), adminCreateUser);
